...
public class ImageController {
	...
	public String showImage(@PathVariable("id") int imageId, Model model) {
		...
		List<Comment> comment = commentService.getAllComments(imageId);
	...
	public String addComment(@RequestParam("comment") String comment, Model model, HttpSession session, @PathVariable("id") int imageId) {
		User user = (User) session.getAttribute("loggeduser");
		Image image = imageService.getImage(imageId);
		...
		commentObj.setCreatedDate(date);
		commentObj.setImage(image);
		commentService.createComment(commentObj);
		
		List<Comment> commentsAll = commentService.getAllComments(imageId);
		
			model.addAttribute("image", image);
			model.addAttribute("tags", image.getTags());
		model.addAttribute("comments", commentsAll);
		return "images/image";
